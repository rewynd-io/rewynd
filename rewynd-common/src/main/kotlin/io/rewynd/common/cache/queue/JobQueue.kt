...
typealias JobHandler<Request, Response, ClientEventPayload, WorkerEventPayload> =
    suspend CoroutineScope.(
        JobContext<Request, Response, ClientEventPayload, WorkerEventPayload>,
    ) -> Response
...
sealed interface ClientEvent {
    @Serializable
    data object NoOp : ClientEvent

    @Serializable
    data object Cancel : ClientEvent
